...
const TIMELINES = {
  "achat-voiture-occasion": {
    ...
    durationWeeks: 3,
    steps: [
      { week: 1, title: "Recherche & comparaison", body: "Définissez budget TCO (pas seulement prix d'achat). Comparez annonces Goovoiture, indices prix et fiabilité. Visitez 3–5 véhicules minimum.", checklist: ["Budget TCO calculé", "Modèles shortlistés", "Annonces favorites sauvegardées"] },
      ...
      { week: 2, title: "Négociation & acompte", body: "Négociez sur base des indices prix Goovoiture. Évitez gros acomptes sans contrat écrit. Privilégiez virement traçable.", checklist: ["Contrat de vente signé", "Reçu d'acompte", "Copie CIN vendeur"] },
  ...
  "vendre-voiture-maroc": {
    ...
    durationWeeks: 4,
    steps: [
      { week: 1, title: "Estimation & préparation", body: "Consultez l'indice prix Goovoiture pour votre modèle. Nettoyez, réparez petits défauts visibles, rassemblez carnet d'entretien.", checklist: ["Prix médian vérifié", "Photos professionnelles", "Historique entretien"] },
      { week: 1, title: "Publication annonce", body: "Publiez sur Goovoiture avec photos honnêtes, kilométrage exact, CT et vignette visibles. Répondez sous 2 h.", checklist: ["Annonce en ligne", "Prix compétitif", "WhatsApp activé"] },
    ...
    faqs: [
      { q: "Comment fixer le bon prix de vente ?", a: "Utilisez le médian Goovoiture pour votre marque/modèle/année — ajustez ±5 % selon état et kilométrage." },
    ...
    relatedLinks: [
      { label: "Vendre sur Goovoiture", path: "/vendre-ma-voiture" },
