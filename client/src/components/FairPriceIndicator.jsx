...
export default function FairPriceIndicator({ listing }) {
  ...
  // Position the price on the min-max scale (0-100%)
  ...
  return (
    <div className="border rounded-xl p-4 bg-gray-50">
      ...
      <div className="relative h-2 bg-gray-200 rounded-full mb-3">
        ...
        <div className="absolute top-1/2 -translate-y-1/2 w-3 h-3 bg-white border-2 border-blue-600 rounded-full" style={{ left: `calc(${position}% - 6px)` }} />
      </div>
