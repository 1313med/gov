...
import { getCityBySlug, MOROCCO_CITIES } from "@client-seo/catalog/cities";
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const meta = professionalsHubMetadata("fr", "dealer", citySlug);
  if (!meta) return {};
...
export default async function Page({ params }: Props) {
  ...
  return <ProfessionalsHubView lang="fr" kind="dealer" citySlug={citySlug} />;
}
