        ...
        <View style={s.form}>
          ...
          <View style={s.roleRow}>
            {ROLES.map((r) => {
              ...
              return (
                <TouchableOpacity key={r.key} onPress={() => set("role", r.key)} style={[s.roleBtn, active && s.roleBtnActive]}>
          ...
          <TouchableOpacity onPress={handleRegister} disabled={loading} style={[s.btn, { opacity: loading ? 0.7 : 1 }]}>
...
function createRegisterStyles(C) {
  return StyleSheet.create({
    ...
    roleBtnActive: { backgroundColor: C.pillBg, borderColor: C.primary },
