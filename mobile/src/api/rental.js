...
export const recordRentalView = (id) => api.post(`/rental/${id}/record-view`);
export const getMyRentals = () => api.get("/rental/mine");
export const getOwnerRentals = () => api.get("/rental/owner/mine");
/** JSON body; `images` = array of HTTPS URLs from /upload/images */
export const createRental = (payload) => api.post("/rental", payload);
